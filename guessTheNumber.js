...
document.querySelector(".tahmin").addEventListener("click", () => {
  ...
  if (!tahmin) {
    ...
    document.querySelector("body").style.backgroundImage =
      "url(./img/ai-generated-8202054_1280.jpg)";
    ...
    if (myScore > 1) {
      ...
      tahmin > tutulanSayi
        ...
        document.querySelector(".sayi").focus();
    } else {
      document.querySelector("body").style.backgroundImage =
        "url(./img/people-7375715_1280.png)";
...
document.querySelector(".dene").onclick = () => {
  ...
  document.querySelector("body").style.backgroundImage = "url(./img/track-19217_1280.jpg)";
